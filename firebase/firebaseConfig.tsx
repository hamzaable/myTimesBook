...
const firebaseConfig = {
	...
	databaseURL: process.env.NEXT_PUBLIC_ENV_LOCAL_FIREBASE_DATABASE_URL,
	...
	messagingSenderId:
		process.env.NEXT_PUBLIC_ENV_LOCAL_FIREBASE_MESSAGING_SENDER_ID,
	appId: process.env.NEXT_PUBLIC_ENV_LOCAL_FIREBASE_APP_ID,
	measurementId: process.env.NEXT_PUBLIC_ENV_LOCAL_FIREBASE_MEASUREMENT_ID,
};

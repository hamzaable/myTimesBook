...
const { updateAllData,updateFilteredAllData } = timeLogActions;

export const getTimeLogs = (data: { dateStart: any; dateFinish: any }) => {
...
export const getFilteredTimeLogs = (data: {
	dateStart: any;
	dateFinish: any;
}) => {
	return async (
		...
		dispatch(updateFilteredAllData(fetchedData));
	};
};
